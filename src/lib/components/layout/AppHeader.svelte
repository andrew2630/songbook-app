		...
		<div class="relative flex flex-col gap-8">
			<div class="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
				<div class="space-y-4 text-center lg:max-w-2xl lg:text-left">
					<div
						class="inline-flex items-center gap-2 self-center rounded-full border border-[rgb(var(--accent-gold)/0.4)] bg-[rgb(var(--accent-gold)/0.15)] px-4 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-[rgb(var(--accent-gold)/0.95)] shadow-sm shadow-[rgba(234,179,8,0.25)] lg:self-start"
					>
						{$t('app.brand_global')}
					</div>
					<div class="space-y-2">
				...
				<div class="flex w-full items-start justify-center lg:max-w-sm lg:justify-end">
					<div
						class="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white/70 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.2em] text-on-surface shadow-sm shadow-primary-500/5 backdrop-blur"
					>
