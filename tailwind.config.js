		...
		skeleton({
			themes: {
				...
				custom: [
					...
					{
						name: 'songbook-meadow',
						properties: {
							...baseThemeProperties,
							'--theme-font-color-base': '21 61 38',
							'--on-secondary': '17 43 60',
							'--on-surface': '18 55 35',
					...
					},
					{
						...
						properties: {
							...baseThemeProperties,
							'--theme-font-color-base': '229 231 235',
							'--theme-font-color-dark': '20 15 36',
							'--on-primary': '248 250 255',
							'--on-secondary': '41 24 11',
							'--on-tertiary': '41 24 11',
							'--on-success': '41 24 11',
							'--on-warning': '41 24 11',
							'--on-error': '249 250 255',
					...
					{
						name: 'songbook-midnight',
						properties: {
							...baseThemeProperties,
							'--theme-font-color-base': '226 232 240',
							'--theme-font-color-dark': '15 23 42',
							'--on-primary': '15 23 42',
							'--on-secondary': '248 250 255',
							'--on-tertiary': '248 250 255',
							'--on-success': '15 23 42',
							'--on-warning': '15 23 42',
							'--on-error': '243 244 255',
